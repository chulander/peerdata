    ...
    <div className={`bg-white ${className}`}>
      <div className="relative isolate overflow-hidden pt-14">
        <div className="mx-auto px-6 lg:px-8">
          <div className="mx-auto lg:mx-auto lg:grid lg:max-w-none lg:grid-cols-4 lg:gap-x-8 lg:gap-y-4">
            ...
            <img
              ...
              src={image.url}
              alt={image.alt}
              className="col-span-2 mt-10 aspect-auto w-full rounded-2xl object-cover sm:mt-12 lg:mt-0 "
            />
          </div>
        </div>
      </div>
