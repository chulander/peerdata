            ...
            <div className="text-base leading-7 text-white lg:max-w-lg">
              ...
              <div className="max-w-xl">
                <p className="mt-8">
                  ...
                  existing standards. Our remote-first teams are situated across
                  North America, Europe and Asia so don't miss this chance! Are
                  you someone who loves collaborating while having a thirst for
                  knowledge when it comes to data science? Then head over to our
                  job listings today!
                </p>
              </div>
            </div>
