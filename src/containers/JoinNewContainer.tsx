          ...
          <div className="mx-auto max-w-7xl pb-32 sm:pt-60 lg:pt-32">
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div className="flex w-full max-w-xl flex-col lg:shrink-0 xl:max-w-2xl">
                ...
                <div className="flex max-w-xl flex-col justify-center mt-6 xl:col-end-1 xl:row-start-1">
                  ...
                  <p className="text-md relative mt-2 leading-8 text-brand-500 sm:max-w-md lg:max-w-none">
                    ...
                    Europe and Asia so don't miss this chance! Are you someone
                    who loves collaborating while having a thirst for knowledge
