        ...
        <div className="mx-auto max-w-7xl pb-32 sm:pt-60 lg:px-8">
          <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div className="flex w-full max-w-xl flex-col lg:shrink-0 xl:max-w-2xl">
              ...
              <div className="mt-6 flex max-w-xl flex-col justify-center xl:col-end-1 xl:row-start-1">
                ...
                <p className="text-md relative mt-2 leading-8 text-brand-500 sm:max-w-md lg:max-w-none">
                  Our remote-first teams are situated across North America,
                  Europe and Asia so don't miss this chance! Are you someone who
                  loves collaborating while having a thirst for knowledge when
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  <NavItem
                    to="/careers"
                    className="rounded-md bg-brand-blue px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-blue"
                  >
                    Careers at PeerData
                  </NavItem>
                  <NavItem
